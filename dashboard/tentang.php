        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h4 mb-0 ml-2 text-gray-800">Tentang Aplikasi - Implementasi Metode Enkripsi AES 128 Bit pada File Data Pengiriman Barang</h1>
                ...
                <div class="container-fluid">
                    <div class="alert alert-success" role="alert">
                        ...
                        Implementasi Metode Enkripsi AES 128 Bit pada File Data Pengiriman Barang - Tentang Aplikasi
                    </div>
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <h6>( Studi Kasus: Ekspedisi Karunia Jaya )</h6>
                                <br>
                                <p>Implementasi Metode Enkripsi AES 128 Bit pada File Data Pengiriman Barang Ekspedisi Karunia Jaya, bertujuan
                                    untuk meminimalisir penyalahgunaan rincian data pengiriman barang oleh pihak yang tidak bertanggungjawab. Metode Enkripsi
                                    AES 128 Bit digunakan untuk mengubah file Data Pengiriman Barang menjadi file ciphertext atau file yang sulit untuk dimengerti makna dan isinya.
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Implementasi Metode Enkripsi AES 128 Bit pada File Data Pengiriman Barang 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
