...
<head>
  ...
  <title>
    Implementasi Metode Enkripsi AES 128 Bit
  </title>
              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-1">Login Implementasi<br>Metode Enkripsi AES 128 Bit<br>pada File Rekapitulasi Tagihan Pelayaran </h1>
                    <img src="assets/assets2/img/logokj.png" class="mt-2 mb-4" width="300">
                  </div>
                  ...
                  <div class="copyright text-center my-auto">
                    <span>Copyright &copy;fildadwi <?= date('Y'); ?> </span>
                  </div>
